...
public class NewWSDLFile_ServiceLocator extends org.apache.axis.client.Service implements com.soapclient.xml.soapresponder_wsdl.NewWSDLFile_Service {
    ...
    public com.soapclient.xml.soapresponder_wsdl.NewWSDLFile_PortType getNewWSDLFileSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public com.soapclient.xml.soapresponder_wsdl.NewWSDLFile_PortType getNewWSDLFileSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.soapclient.xml.soapresponder_wsdl.NewWSDLFileSOAPStub _stub = new com.soapclient.xml.soapresponder_wsdl.NewWSDLFileSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.soapclient.xml.soapresponder_wsdl.NewWSDLFile_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.soapclient.xml.soapresponder_wsdl.NewWSDLFileSOAPStub _stub = new com.soapclient.xml.soapresponder_wsdl.NewWSDLFileSOAPStub(new java.net.URL(NewWSDLFileSOAP_address), this);
                _stub.setPortName(getNewWSDLFileSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapclient.com/xml/soapresponder.wsdl", "NewWSDLFile");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapclient.com/xml/soapresponder.wsdl", "NewWSDLFileSOAP"));
        }
